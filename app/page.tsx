  ...
  return (
    <LanguageProvider>
      <div className="min-h-screen bg-[#F8F9FA] text-gray-900 font-sans flex flex-col">
        ...
        {/* Modern Main Footer */}
        <footer className="no-print bg-gray-950 text-gray-400 border-t border-gray-900 py-6 text-xs">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
            
            {/* Author & Social Links */}
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
              <span className="font-medium text-gray-300 flex items-center gap-1.5">
                Created with <Heart className="w-3.5 h-3.5 text-red-500 fill-red-500 shrink-0" /> by <strong className="font-bold text-white">Nikhil Khanpara</strong>
              </span>
              ...
              <div className="flex items-center space-x-2">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-gray-900 text-gray-300 hover:text-white hover:bg-gray-800 transition-colors font-medium border border-gray-800/80"
                >
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-3">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md text-gray-400 hover:text-white transition-colors hover:bg-gray-900 border border-transparent hover:border-gray-800"
              >
                <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" />
                <span>Privacy & Storage Notice</span>
              </button>
              <span className="text-gray-800 hidden sm:inline">•</span>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-emerald-500/10 text-emerald-400 text-[11px] font-mono font-semibold border border-emerald-500/20">
